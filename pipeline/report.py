...
<h2>05 · Results synthesis: collect fits, plots and tables</h2><p>A separate synthesis stage verifies the four fits, combines comparison tables and draws the CPUE and biomass plots. The report stage packages these outputs and their provenance.</p><h2>06 · Produce the draft report</h2><table class="trail">{trail}</table>
